...
public class BiConsumers {
	...
	BiConsumer<Employee, Integer> empBonusConsumer =
			(emp, bonus) -> System.out.printf("com.devbrat2k.advancedlambdas.Employee %s is set of %d pct of bonus:", emp, bonus);
			
	BiConsumer<Employee, Integer> empSalHikeConsumer = (emp, sal) ->
		System.out.printf("com.devbrat2k.advancedlambdas.Employee %s is receiving %d hike in salary", emp, sal);
