...
package com.devbrat2k.jni;

/**
 * {@code LibraryLoaders} will create the appropriate {@link LibraryLoader} for
 * the VM it is running on.
 *
 * The system property {@code com.devbrat2k.jni.loader} may be used to override
...
public class LibraryLoaders {
    ...
    public static LibraryLoader loader() {
        String type = System.getProperty("com.devbrat2k.jni.loader");
        ...
        if (type != null) {
            ...
            throw new IllegalStateException("Illegal value for com.devbrat2k.jni.loader: " + type);
        }
