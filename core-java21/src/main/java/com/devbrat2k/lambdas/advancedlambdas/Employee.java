package com.devbrat2k.lambdas.advancedlambdas;
...
public class Employee {
	...
	/**
	 * An com.devbrat2k.lambdas.advancedlambdas.Employee created using an id
	 * @param id
	 */
	...
	/**
	 * An com.devbrat2k.lambdas.advancedlambdas.Employee created using an id and a name
	 * @param id
	 * @param name
	 */
